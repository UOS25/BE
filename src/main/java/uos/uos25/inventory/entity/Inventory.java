...
public class Inventory extends BaseEntity {
    ...
    @Builder
    public Inventory(Long inventoryId, Integer ea, LocalDateTime warehousingDate, Integer display, LocalDateTime expirationDate, Shop shop, Product product) {
    ...
    public void changeDisplay(Integer ea){
        if(this.ea < ea)
            throw new InventoryEaNotEnoughException();
        if(this.ea < display)
            throw new InventoryTooManyDisplayException();
