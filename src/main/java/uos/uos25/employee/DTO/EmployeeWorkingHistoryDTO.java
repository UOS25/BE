 ...
 * 서비스 메소드 별 요구 필드
 *
 * <p>findAllEmployeeWorkingHistories: 해당 직원의 출퇴근 기록을 모두 불러오는 메소드 BE 단에서 네 가지 필드 모두 채워서 보내드립니다.
 *
 * <p>addWorkingHistory: 임의로 직원의 출퇴근 기록을 추가하는 메소드 필요 필드: employeeId, startDateTime, endDateTime
 */
@Getter
@Setter
